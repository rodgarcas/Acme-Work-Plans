...
public class AuthenticatedTaskListAllTest extends AcmeWorkPlansTest {
	...
	/*
	Feature: C-Task-009: List public tasks finished & 
	C-Task-010: Show details public tasks finished& AuthenticatedTaskListFinishedService
	Authorisation required: Authenticated
	Imposed constraints: None
	Violated constraints: None
	Expected result: Visualisation of finished task
	*/
	@ParameterizedTest
